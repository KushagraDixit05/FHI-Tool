    ...
    <div className="space-y-5 max-w-7xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Manage your supplier network</p>
        </div>
        <Link
          href="/suppliers/new"
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm flex flex-col items-center justify-center py-20 text-center">
        ...
        <h3 className="font-semibold text-slate-700 mb-1">No suppliers yet</h3>
        <p className="text-sm text-slate-400 mb-6 max-w-xs">
          Add suppliers with their certifications, MOQs, and lead times.
        </p>
        <Link
          href="/suppliers/new"
